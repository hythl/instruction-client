...
const CourseView = () => {
  ...
  const handlePublish = async (e, courseId) => {
    try{
      let answer = window.confirm('Once you publish your course, it will be live in the marketplace for user to enroll');
      if(! answer) return;
  ...
  const handleUnpublish= async (e, courseId) => {
    try{
      let answer = window.confirm('Once you unpublish, user cannot enroll in this course');
      if(! answer) return;
                  ...
                  <Tooltip title="Edit">
                    ...
                    <Tooltip title="Min 5 lessons required to publish">
                      ...
                      <Tooltip title="Publish">
                        <CheckOutlined onClick={e => handlePublish(e, course._id)} className="h5 pointer text-danger"/>
                      </Tooltip>
                    )}
